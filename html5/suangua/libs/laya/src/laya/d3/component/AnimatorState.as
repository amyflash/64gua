package laya.d3.component {
	...
	public class AnimatorState implements IClone {
		...
		/**@private */
		public var _currentFrameIndices:Uint16Array;
		/**@private */
		 ...
		 * @private
		 */
		private function _initFrameIndices(clip:AnimationClip):void {
			_currentFrameIndices = new Uint16Array(clip._nodes.count);
		}
